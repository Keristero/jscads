...
function getObject({vslot_length,vslot_width,vslot_depth,camera_mount_height,camera_mount_screw_slot_width}) {
    ...
    const slot_height = camera_mount_height-15
    ...
    let camera_mount_slot_cutout = cuboid({size: [camera_mount_screw_slot_width, camera_plate_thickness, slot_height],center:[0,camera_plate_offset,vslot_depth+10+(slot_height/2)]})
...
function getParameterDefinitions() {
    return [
        { name: 'vslot_length', type: 'float', initial: 50, caption: 'vslot length' },
        { name: 'vslot_width', type: 'float', initial: 6.5, caption: 'vslot width' }, 
        { name: 'vslot_depth', type: 'float', initial: 5, caption: 'vslot depth' }, 
        { name: 'camera_mount_height', type: 'int', initial: 45, caption: 'mount height' }, 
        { name: 'camera_mount_screw_slot_width', type: 'int', initial: 6, caption: 'mount height' }, 
    ];
}
