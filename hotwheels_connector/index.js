...
const left_catch_center = [-15.3,0,base_dimensions.height+(catch_dimensions.height/2)]
const right_catch_center = [15.3,0,base_dimensions.height+(catch_dimensions.height/2)]
...
const main = () => {
    ...
    const middle_bridge = cuboid({size:[base_dimensions.length,4,base_dimensions.height/2],center:[0,0,(base_dimensions.height/4)]})
    ...
    const left_catch_base = cylinder({center:[-15.3,0,(base_dimensions.height/2)+(catch_dimensions.height/2)],height: (base_dimensions.height)+(catch_dimensions.height/2), radius: catch_dimensions.diameter/2,segments:32})
    const right_catch_base = cylinder({center:[15.3,0,(base_dimensions.height/2)+(catch_dimensions.height/2)],height: (base_dimensions.height)+(catch_dimensions.height/2), radius: catch_dimensions.diameter/2,segments:32})
    ...
    left_catch_cutter = translate([-16.3,0,3+(base_dimensions.height/2)+(catch_dimensions.height)],left_catch_cutter)
    ...
    right_catch_cutter = translate([16.3,0,3+(base_dimensions.height/2)+(catch_dimensions.height)],right_catch_cutter)
